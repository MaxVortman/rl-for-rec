from datasets.transformer_datasets import TransformerDatasetTest, TransformerDatasetTestCollator, TransformerDatasetTrain, TransformerDatasetTrainCollator
...
from models.transformer import TransformerModel, generate_square_subsequent_mask, create_pad_mask
...
def get_loaders(
    ...
    train_loader = DataLoader(
        ...
        shuffle=True,
        collate_fn=TransformerDatasetTrainCollator(max_size=max_size, padding_idx=padding_idx),
...
def train_fn(
    ...
    with tqdm(total=n_batches, desc="train") as progress:
        for idx, batch in enumerate(loader):
            ...
            output = model(src=sources, src_mask=src_mask, src_key_padding_mask=pad_mask)
